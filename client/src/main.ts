...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [LoginScene, GarageScene, TownScene, JobBoardScene, VehicleDesignerScene, ArenaScene, TacticalOverlay, ShopScene, MapViewerScene, MapEditorScene, WorldMapScene, ReportScene, ResultScene, ReplayScene, LeaderboardScene, ActivityScene]
};

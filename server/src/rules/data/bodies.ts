...
export const BODIES: BodyDef[] = [
  ...
  { id: 'trike',         name: 'Trike',         price: 350,  baseWeight: 500,  maxLoad: 1600,  spaces: 6,  armorCostPerPt: 11, armorWtPerPt: 5,  baseHC: 3, isCycle: true,  tireCount: 3 },
  // Heavy vehicles
  { id: 'truck',         name: 'Truck',         price: 1500, baseWeight: 3000, maxLoad: 8000,  spaces: 10, armorCostPerPt: 35, armorWtPerPt: 16, baseHC: 1, isCycle: false },
  { id: 'trailer',       name: 'Trailer',       price: 500,  baseWeight: 1500, maxLoad: 14000, spaces: 30, armorCostPerPt: 25, armorWtPerPt: 12, baseHC: 1, isCycle: false },
];
